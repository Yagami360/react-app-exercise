...
exports.searchTweet = functions.https.onRequest((request, response) => {
  ...
  // Twitter API のクライアント作成
  const client = new Twitter({
    consumer_key: request.body["twitter_consumer_key"],
    consumer_secret: request.body["twitter_consumer_secret"],
    access_token_key: request.body["twitter_access_token_key"],
    access_token_secret: request.body["twitter_access_secret"],
  })
