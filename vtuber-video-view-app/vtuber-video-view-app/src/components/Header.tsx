      ...
      <Toolbar>
        ...
        <Drawer anchor="left" open={isOpenMenuDrawer} onClose={onCloseMenuDrawer}>
          ...
          <List component="nav">
            ...
            <Link to={AppConfig.vtuberSearchPage.path} style={{ textDecoration: 'none', color: 'black' }}>
              <ListItem button>
                <ListItemText primary="VTuber検索" />
              </ListItem>
            </Link>
            ...
            <Link to={AppConfig.favVTuberPage.path} style={{ textDecoration: 'none', color: 'black' }}>
              <ListItem button>
                <ListItemText primary="お気に入りVTuber" />
              </ListItem>
            </Link>
            <Link to={AppConfig.favVideoPage.path} style={{ textDecoration: 'none', color: 'black' }}>
              <ListItem button>
                <ListItemText primary="お気に入り動画" />
              </ListItem>
            </Link>
          </List>
        </Drawer>
        ...
        <Box>
          <Tabs value={selectedTab} onChange={onChangeSelectedTab} TabIndicatorProps={{style: {background:'#FFFFFF'}}}>
            <Tab label="VTuber検索" component={Link} to={AppConfig.vtuberSearchPage.path} />
            <Tab label="動画検索" component={Link} to={AppConfig.videoSearchPage.path} />
            <Tab label="お気に入りVTuber" component={Link} to={AppConfig.favVTuberPage.path} />
            <Tab label="お気に入り動画" component={Link} to={AppConfig.favVideoPage.path} />
          </Tabs>
        </Box>
        { /* ダークモード切り替えボタン */ }
