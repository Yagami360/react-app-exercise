...
import AppConfig, { FavVideoPageConfig } from '../Config'
...
const FavVideoPage: React.VFC = () => {
  ...
  useEffect(() => {
    ...
    if (authCurrentUser !== null) {
      ...
      firestore.collection(FavVideoPageConfig.collectionNameFav).doc(authCurrentUser?.email).collection(FavVideoPageConfig.collectionNameFav).get().then(
                  ...
                  .then( (videoInfo_: any) => {
                    ...
                    const favJsx_ = (
                      <YouTubeVideoInfoCard 
                        ...
                        thumbnailsUrl={field.thumbnailsUrl} imageHeight={FavVideoPageConfig.imageHeight} imageWidth={FavVideoPageConfig.imageWidth}
  ...
  return (
    <ThemeProvider theme={darkMode ? AppTheme.darkTheme : AppTheme.lightTheme}>
      ...
      <CssBaseline />
      {/* ヘッダー表示 */}
      <Header title={AppConfig.title} selectedTabIdx={AppConfig.favVideoPage.index} photoURL={authCurrentUser !== null ? authCurrentUser?.photoURL : ''} darkMode={darkMode} setDarkMode={setDarkMode}></Header>
      {/* ボディ表示 */}
